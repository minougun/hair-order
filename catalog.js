...
export const HAIR_CATALOG = [
  ...
  // ── 福岡 ───────────────────────────────────────────
  {
    id: "C21",
    title: "天神ビジネスショート",
    subtitle: "清潔感と再現性を両立した福岡スタンダード",
    sourceName: "EARTH 天神西通り店",
    location: location(33.5894, 130.3950, "福岡県", "天神", ["福岡", "博多", "天神", "福岡市", "九州"]),
    externalLinks: links("", "https://www.earth-hair.com/", "", DEFAULT_BOOKING_URL),
    tags: ["length_short", "goal_business", "goal_clean", "time_3", "tool_no_iron", "shape_tight_side", "style_natural", "occasion_office", "gender_male"],
  },
  {
    id: "C22",
    title: "福岡まとまりミディアム",
    subtitle: "うねりを活かすやわらかフォルム",
    sourceName: "mod's hair 天神西通り店",
    location: location(33.5904, 130.3990, "福岡県", "天神", ["福岡", "博多", "天神", "福岡市", "九州"]),
    externalLinks: links("", "https://www.mods-hair.com/", "", DEFAULT_BOOKING_URL),
    tags: ["length_medium", "goal_soft", "goal_casual", "time_7", "tool_no_iron", "style_layer", "hair_wavy", "shape_anti_frizz", "gender_unisex"],
  },
  // ── 名古屋 ───────────────────────────────────────────
  {
    id: "C23",
    title: "栄ビジネスショート",
    subtitle: "職場向けの清潔感重視スタイル",
    sourceName: "EARTH 栄店",
    location: location(35.1709, 136.9071, "愛知県", "栄", ["名古屋", "愛知", "錦", "伏見", "中部"]),
    externalLinks: links("", "https://www.earth-hair.com/", "", DEFAULT_BOOKING_URL),
    tags: ["length_short", "goal_business", "goal_clean", "time_3", "tool_no_iron", "shape_control_bangs", "style_natural", "occasion_office", "gender_male"],
  },
  {
    id: "C24",
    title: "名古屋センターパートミディアム",
    subtitle: "韓国っぽい落ち感シルエット",
    sourceName: "MINX 名古屋店",
    location: location(35.1706, 136.8816, "愛知県", "名古屋駅", ["名古屋", "愛知", "名駅", "中部"]),
    externalLinks: links("", "https://minx-net.co.jp/", "", DEFAULT_BOOKING_URL),
    tags: ["length_medium", "goal_korean", "goal_sharp", "time_15", "tool_iron_ok", "style_center_part", "style_korean", "occasion_flexible", "gender_male"],
  },
  // ── 横浜・神奈川 ───────────────────────────────────────────
  {
    id: "C25",
    title: "横浜ナチュラルショート",
    subtitle: "みなとみらいエリア向けの清潔感設計",
    sourceName: "MINX 横浜店",
    location: location(35.4437, 139.6380, "神奈川県", "横浜", ["横浜", "関内", "みなとみらい", "神奈川"]),
    externalLinks: links("", "https://minx-net.co.jp/", "", DEFAULT_BOOKING_URL),
    tags: ["length_short", "goal_clean", "goal_business", "time_3", "tool_no_iron", "style_natural", "shape_control_bangs", "occasion_office", "gender_male"],
  },
  {
    id: "C26",
    title: "横浜ウェーブレイヤー",
    subtitle: "うねりを活かすカジュアルミディアム",
    sourceName: "SHIMA 横浜店",
    location: location(35.4660, 139.6220, "神奈川県", "横浜", ["横浜", "みなとみらい", "馬車道", "神奈川"]),
    externalLinks: links("", "https://www.shima-hair.com/", "", DEFAULT_BOOKING_URL),
    tags: ["length_medium", "goal_casual", "goal_soft", "time_15", "tool_iron_ok", "style_layer", "hair_wavy", "style_texture", "gender_female"],
  },
  // ── 札幌 ───────────────────────────────────────────
  {
    id: "C27",
    title: "札幌クリーンショート",
    subtitle: "北海道の気候でも扱いやすいスタイル",
    sourceName: "EARTH 大通店",
    location: location(43.0621, 141.3545, "北海道", "大通", ["札幌", "大通", "すすきの", "北海道"]),
    externalLinks: links("", "https://www.earth-hair.com/", "", DEFAULT_BOOKING_URL),
    tags: ["length_short", "goal_clean", "time_3", "tool_no_iron", "style_natural", "shape_anti_frizz", "occasion_office", "gender_unisex"],
  },
  // ── 仙台 ───────────────────────────────────────────
  {
    id: "C28",
    title: "仙台ナチュラルショート",
    subtitle: "東北向けの扱いやすい清潔感スタイル",
    sourceName: "EARTH 仙台店",
    location: location(38.2600, 140.8824, "宮城県", "仙台", ["仙台", "宮城", "青葉区", "東北"]),
    externalLinks: links("", "https://www.earth-hair.com/", "", DEFAULT_BOOKING_URL),
    tags: ["length_short", "goal_clean", "goal_business", "time_3", "tool_no_iron", "style_natural", "occasion_office", "gender_male"],
  },
  // ── 広島 ───────────────────────────────────────────
  {
    id: "C29",
    title: "広島まとまりミディアム",
    subtitle: "広がりを抑えるナチュラルレイヤー",
    sourceName: "SHIMA 広島店",
    location: location(34.3955, 132.4596, "広島県", "紙屋町", ["広島", "八丁堀", "紙屋町", "中国"]),
    externalLinks: links("", "https://www.shima-hair.com/", "", DEFAULT_BOOKING_URL),
    tags: ["length_medium", "goal_clean", "goal_soft", "time_7", "tool_no_iron", "style_layer", "shape_anti_frizz", "style_natural", "gender_unisex"],
  },
  // ── 金沢 ───────────────────────────────────────────
  {
    id: "C30",
    title: "金沢まとまりミディアム",
    subtitle: "北陸の湿気対策を想定した広がり対策設計",
    sourceName: "EARTH 金沢香林坊店",
    location: location(36.5613, 136.6562, "石川県", "金沢", ["金沢", "石川", "香林坊", "北陸"]),
    externalLinks: links("", "https://www.earth-hair.com/", "", DEFAULT_BOOKING_URL),
    tags: ["length_medium", "goal_clean", "goal_soft", "time_7", "tool_no_iron", "shape_anti_frizz", "style_natural", "occasion_flexible", "gender_unisex"],
  },
];
